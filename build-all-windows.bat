del bin\*
del *.obj
cl /EHsc /O2 /Ot /GL /w /DWATCHEDLITERALS  /DNO_PRINT /DMORE_SEARCH_INFO minion\help\*.cpp minion\*.cpp minion\build_constraints\*.cpp /link /OUT:bin\minion-debug.exe
cl /EHsc /O2 /Ot /GL /w /DWATCHEDLITERALS  /DNO_DEBUG minion\help\*.cpp minion\*.cpp minion\build_constraints\*.cpp /link /OUT:bin\minion.exe
