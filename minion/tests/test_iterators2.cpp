...
int main(void)
{
  ...
  {
	VarIterator_looping<LRangeVarRef> it2(a, 1);
	D_ASSERT(it2.val() == 1);
	D_ASSERT(it2.step() && it2.step() && it2.step());
	D_ASSERT(it2.val() == 6);
	D_ASSERT(it2.step());
	D_ASSERT(it2.val() == 0);
	D_ASSERT(!it2.step());
  ...
  {
	VarIterator_looping<LRangeVarRef> it3(a, 2);
	D_ASSERT(it3.val() == 3);
	D_ASSERT(it3.step() && it3.step() && it3.step() && it3.step());
	D_ASSERT(it3.val() == 1);
	D_ASSERT(!it3.step());
  }
