...
struct ConcreteFileReader {
  ...
  BOOL failed_open() { return !infile; }
  ...
  DomainInt read_num() { return this->read_int(); }
  ...
  string simplegetline() { return infile.getline(); }
  ...
  void putback(char c) { infile.putback(c); }
...
public:
  ...
  void setGadgetReader() { isGadgetReader_m = true; }
  bool isGadgetReader() { return isGadgetReader_m; }
