...
if("constraints shortctuplestr2" == request) {
cout << "Help entry: " << "constraints shortctuplestr2" << endl << endl;
cout << "Description" << "---------------------------------------------------------------------" << endl;
cout << "" << endl
...
<< "" << endl
<< "**CONSTRAINTS**" << endl
<< "shortctuplestr2([x1,x2,x3,x4], mycon)" << endl << endl << endl;
} else
if("constraints shortcuplestr2" == request) {
cout << "Help entry: " << "constraints shortcuplestr2" << endl << endl;
cout << "Notes" << "---------------------------------------------------------------------------" << endl;
cout << "This constraint enforces generalized arc consistency." << endl << endl << endl;
} else
if("constraints shortctuplestr2" == request) {
...
<< " <Tuplelist>*" << endl
<< "" << endl
<< "Tuplelist::= <name> <num_tuples> <tupleLength> <numbers>+" << endl << endl << endl;
cout << "Example" << "-------------------------------------------------------------------------" << endl;
cout << "**TUPLELIST**" << endl
<< "AtMostOne 4 3" << endl
<< "0 0 0" << endl
...
<< "or maximise a variable's value, or list of variables (under" << endl
<< "lexicographic ordering)" << endl
<< "" << endl
<< " OptimisationFn::= MAXIMISING <varname> or <varlist>" << endl
<< " | MINIMISING <varname> or <varlist>" << endl
<< "" << endl
...
if("switches -valorder" == request) {
cout << "Help entry: " << "switches -valorder" << endl << endl;
cout << "Description" << "---------------------------------------------------------------------" << endl;
cout << "" << endl
<< "Choose the value ordering (overruling any selection in the input file)." << endl
<< "" << endl
<< "Current orders are, ascend, descend and random." << endl << endl << endl;
} else
if("/boot" == request) {
...
cout << "/cdrom" << "--------------------------------------------------------------------------" << endl;
cout << "Append all solutions to a named file, as JSON objects." << endl
<< " Each solution is store as a seperate JSON object." << endl << endl << endl;
cout << "/cdrom" << "--------------------------------------------------------------------------" << endl;
cout << "To add the solutions of myproblem.minion to mysols.txt do" << endl
<< "" << endl
<< " minion -jsonsolsout mysols.json myproblem.minion" << endl << endl << endl;
cout << "/cdrom" << "--------------------------------------------------------------------------" << endl;
...
cout << "help switches -valorder" << endl;
