...
void help(string request) {
  if("" == request) {
    cout << "To use this help feature run the minion executable followed by help followed by the"
         << endl;
    cout << "entry you wish to see. For example to see documentation on variables you should type:"
         << endl
         << endl;
    cout << "   minion help variables" << endl << endl;
    cout << "You can find out what other entries are available, if any, by looking at the "
            "'subentries'"
         << endl;
    ...
    cout << "Try to rduce the initial domains of variables, and output them." << endl
         << " This is in general not useful for users, but is provided for other systems." << endl
         << endl
         << endl;
    ...
    cout << "Automatically generate a short tuple list from each long tuple list." << endl
         ...
         << " eager : Use a fast algorithm to produce a reasonable short tuple list (best" << endl
         << " as first choice)" << endl
         << " lazy : Work harder (possibly exponentially) to produce a shorter short tuple" << endl
         << " list" << endl
    ...
    cout << "Print out the branching decisions and variable states at each node." << endl
         << endl
         << endl;
  } else if("switches -dumptreejson" == request) {
    cout << "Help entry: "
         << "switches -dumptreejson" << endl
         << endl;
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "Print out the branching decisions and variable states at each node." << endl
         << " Accepts filename to output tree to" << endl
         << endl
         << endl;
    ...
    cout << "By default Minion adds all variables to the varorder, to ensure that all" << endl
         ...
         << " that" << endl
         << " behaviour. This means minion Minion may output solutions incorrectly, or" << endl
         << " incorrect" << endl
         << " numbers of solutions. This flag is provided because some users require this" << endl
         << " low-level control over the search, but is in general useless and dangerous." << endl
         << " In particular," << endl
         << " it will not speed up search (except when the speed up is due to producing" << endl
         << " garbage of course!)" << endl
         << endl
         << endl;
    ...
    cout << "When Minion is terminated before the end of search, write out two new input" << endl
         ...
         << " rule out the search already done. In addition, the domain of the variable" << endl
         << " under" << endl
         ...
         << "" << endl
         << " This feature is experimental and intended to facilitate parallelisation --" << endl
         << " to" << endl
         << " parallelise the solving of a single constraint problem, stop and split" << endl
         << " repeatedly. Please note that large-scale testing of this feature was limited" << endl
         << " to" << endl
         ...
         << " instance, the string 'resume', a timestamp, the process ID of Minion, the" << endl
         << " name" << endl
         << " of the variable whose domain is being split and 0 or 1. Each of the new" << endl
         << " input" << endl
         << " files has a comment identifying the name of the input file which it was" << endl
         << " split" << endl
         << " from. Similarly, Minion's output identifies the new input files it writes" << endl
         << " when" << endl
         << " splitting." << endl
         << "" << endl
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "For a latin square this constraint is placed on the whole matrix once for each" << endl
         << "value." << endl
         << "It ensures there is a bipartite matching between rows and columns where the" << endl
         << "edges" << endl
         << "in the matching correspond to a pair (row, column) where the variable in" << endl
         << "position" << endl
    ...
    cout << "This constraint adds some extra reasoning in addition to the GAC Alldifferents" << endl
         ...
         << endl
         << endl;
  } else if("constraints alldiffciaran" == request) {
    cout << "Help entry: "
         << "constraints alldiffciaran" << endl
         << endl;
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "Forces the input vector of variables to take distinct values. This is for experiment "
            "only."
         << endl
         << endl
         << endl;
    ...
    cout << "The constraint" << endl
         ...
         << " vec0 is lexicographically less than or equal to vec1 in any solution." << endl
         << endl
         << endl;
    cout << "Notes"
         << "---------------------------------------------------------------------------" << endl;
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "The Generalized Cardinality Constraint (GCC) constrains the number of each value"
         << endl
    ...
    cout << "" << endl
         ...
         << "" << endl
         << "and now the variables [x1,x2,x3,x4] will satisfy the constraint mycon." << endl
         << endl
         << endl;
    cout << "References"
         << "----------------------------------------------------------------------" << endl;
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "MDDC (mddc) is an implementation of MDDC(sp) by Cheng and Yap. It enforces GAC" << endl
         << "on a" << endl
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "Negative MDDC (negativemddc) is an implementation of MDDC(sp) by Cheng and Yap."
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << " max(vec, x)" << endl
         << "" << endl
         << "ensures that x is equal to the maximum value of any variable in vec." << endl
         << endl
         << endl;
    cout << "References"
         << "----------------------------------------------------------------------" << endl;
    ...
    cout << "The constraint" << endl
         ...
         << " min(vec, x)" << endl
         << "" << endl
         << "ensures that x is equal to the minimum value of any variable in vec." << endl
         << endl
         << endl;
    cout << "References"
         << "----------------------------------------------------------------------" << endl;
    ...
    cout << "The constraint" << endl
         ...
         << " nvalueleq(V,x)" << endl
         << "" << endl
         << "ensures that there are <= x different values assigned to the list of variables" << endl
         << "V." << endl
         << endl
         << endl;
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "str2plus is an implementation of the STR2+ algorithm by Christophe Lecoutre." << endl
         << endl
         << endl;
    cout << "Example"
         << "-------------------------------------------------------------------------" << endl;
    ...
    cout << "Notes"
         << "---------------------------------------------------------------------------" << endl;
    cout << "This constraint enforces generalized arc consistency." << endl << endl << endl;
  } else if("constraints shortctuplestr2" == request) {
    cout << "Help entry: "
         << "constraints shortctuplestr2" << endl
         << endl;
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "" << endl
         << "This constraint extends the ShortSTR2 algorithm to support short c-tuples" << endl
         << "(that is, short tuples which contain can contain more than one domain value" << endl
         << "per constraint)." << endl
         << endl
         << endl;
    cout << "Example"
         << "-------------------------------------------------------------------------" << endl;
    cout << "" << endl
         << "Input format is similar to that used by other short tuple constraints," << endl
         << "such as haggisgac or shortstr2. Refer to the haggisgac and" << endl
         << "shorttuplelist pages for more information." << endl
         << "" << endl
         << "The important change is that more than one literal may be given for each" << endl
         << "variable. Variables which are not mentioned are assumed to be allowed" << endl
         << "to take any value" << endl
         << "" << endl
         << "Example:" << endl
         << "" << endl
         << "**SHORTTUPLELIST**" << endl
         ...
         << "" << endl
         << "**CONSTRAINTS**" << endl
         << "shortctuplestr2([x1,x2,x3,x4], mycon)" << endl
         << endl
         << endl;
  } else if("constraints shortcuplestr2" == request) {
    cout << "Help entry: "
         << "constraints shortcuplestr2" << endl
         << endl;
    cout << "Notes"
         << "---------------------------------------------------------------------------" << endl;
    cout << "This constraint enforces generalized arc consistency." << endl << endl << endl;
    ...
    cout << "The constraint" << endl
         ...
         << "the size of the set {i | X[i] != y[i]} is greater than or equal to c." << endl
         << endl
         << endl;
    ...
    cout << "Notes"
         << "---------------------------------------------------------------------------" << endl;
    cout << "ALMOST ALL constraints are are reifiable. Individual constraint entries mention"
         << endl
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "The constraint w-notinset(x, [a1,...,an]) ensures that x does not belong to the"
         << endl
         << "set {a1,..,an}." << endl
         << endl
         << endl;
    ...
    cout << "" << endl
         ...
         << "" << endl
         << "See the associated help entries below for information on each section." << endl
         << endl
         << endl;
    cout << "Notes"
         << "---------------------------------------------------------------------------" << endl;
    ...
    cout << "A shorttuplelist section lists of allowed tuples for haggisgac," << endl
         << "shortstr2, shortctuplestr2 and other constraints which accept" << endl
         << "short tuple lists." << endl
         << "" << endl
         << "The required format is" << endl
         << "" << endl
         << "TuplelistSection::= **TUPLELIST**" << endl
    ...
    cout << "**SHORTTUPLELIST**" << endl
         ...
         << "3 is 0, then the constraint is true'." << endl
         << "" << endl
         << "Some constraints (currently just shortctuplestr2) allow more than" << endl
         << "one literal per variable for example:" << endl
         << "" << endl
         << "[(0,0),(0,1),(3,0)]" << endl
         << "" << endl
         << "Represents 'If the variable at index 0 is 0 or 1, and the variable at index" << endl
         << "3 is 0, then the constraint is true'." << endl
         << "" << endl
    ...
    cout << "" << endl
         ...
         << " where" << endl
         << "" << endl
         << " <ORDER>::= STATIC | SDF | SRF | LDF | ORIGINAL | WDEG | CONFLICT |" << endl
         << "DOMOVERWDEG" << endl
         << "" << endl
    ...
    cout << "Minion supports many constraints and these are regularly being" << endl
         ...
         << " expressions for variables, vectors, etc. in the section on variables." << endl
         << endl
         << endl;
    cout << "References"
         << "----------------------------------------------------------------------" << endl;
    ...
    cout << "Description"
         << "---------------------------------------------------------------------" << endl;
    cout << "Minion supports the use of constants anywhere where a variable can be used. For"
         << endl
  ...
  if("" == request) {
    ...
    cout << "help constraints alldiffciaran" << endl;
    ...
    cout << "help constraints shortctuplestr2" << endl;
    cout << "help constraints shortcuplestr2" << endl;
