...
void help(string request) {
  if("" == request) {
    cout << "To use this help feature run the minion executable followed by "
         ...
         << endl;
    cout << "entry you wish to see. For example to see documentation on "
            "variables you should type:"
         << endl
         << endl;
    cout << "   minion help variables" << endl << endl;
    cout << "You can find out what other entries are available, if any, by "
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Minion supports a number of switches to augment default "
            "behaviour. To"
         << endl
    ...
    cout << "Try to rduce the initial domains of variables, and output them." << endl
         << "This is in general not useful for users, but is provided for "
            "other systems."
         << endl
         << endl
         << endl;
    ...
    cout << "Output a Minion instance with some basic reasoning performed to" << endl
         ...
         << "output the original instance but may solve faster." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "To enforce SSAC during search:" << endl
         << "" << endl
         << " minion -prop-node SSAC input.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Automatically generate a short tuple list from each long tuple "
            "list."
         << endl
         << "" << endl
    ...
    cout << "" << endl
         ...
         << "- SAC can be achieved in the model when domains are replaced by "
            "either"
         << endl
         << "the singleton containing their upper bound, or the singleton "
            "containing"
         << endl
         ...
         << "achieve. Preprocessing is a one off cost at the start of search. "
            "The"
         << endl
         << "success of higher levels of preprocessing is problem specific; SAC" << endl
         << "preprocesses may take a long time to complete, but may reduce "
            "search"
         << endl
    ...
    cout << "To enforce SAC before search:" << endl
         << "" << endl
         << " minion -preprocess SAC myinputfile.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Disable incremental propagation. This should always slow down "
            "search while producing exactly the same"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Do not check solutions for correctness before printing them out." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "To stop search after N nodes, do" << endl
         << "" << endl
         << " minion -nodelimit N myinput.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "To stop search after N solutions have been found, do" << endl
         << "" << endl
         << " minion -sollimit N myinput.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "To stop search after N seconds (real time), do" << endl
         << "" << endl
         << " minion -timelimit N myinput.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "By default Minion adds all variables to the varorder, to ensure "
            "that all variables"
         << endl
         << "are branched assigned before a solution is outputted. This option "
            "disables that"
         << endl
         << "behaviour. This means minion Minion may output solutions "
            "incorrectly, or incorrect"
         << endl
         << "numbers of solutions. This flag is provided because some users "
            "require this "
         << endl
         << "low-level control over the search, but is in general useless and "
            "dangerous. In particular,"
         << endl
         << "it will not speed up search (except when the speed up is due to "
            "producing garbage of course!)"
         << endl
         << endl
         << endl;
    ...
    cout << "To stop search after N seconds (CPU time), do" << endl
         << "" << endl
         << " minion -cpulimit N myinput.minion" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Randomises the ordering of the decision variables, and the value "
            "ordering."
         << endl
         << "If the input file specifies as ordering it will randomly permute "
            "this. If no ordering is"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Set the pseudorandom seed to N. This allows 'random' behaviour to "
            "be"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Append a line of data about the current run of minion to a named "
            "file."
         << endl
         << "This data includes minion version information, arguments to the" << endl
         << "executable, build and solve time statistics, etc. See the file "
            "itself"
         << endl
         << "for a precise schema of the supplied information." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "Append all solutionsto a named file." << endl
         << "Each solution is placed on a line, with no extra formatting." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "When Minion is terminated before the end of search, write out two "
            "new input"
         << endl
         << "files that split the remaining search space in half. Each of the "
            "files will have"
         << endl
         << "all the variables and constraints of the original file plus "
            "constraints that"
         << endl
         << "rule out the search already done. In addition, the domain of the "
            "variable under"
         << endl
         << "consideration when Minion was stopped is split in half with each "
            "of the new"
         << endl
         << "input files considering a different half." << endl
         << "" << endl
         << "This feature is experimental and intended to facilitate "
            "parallelisation -- to"
         << endl
         << "parallelise the solving of a single constraint problem, stop and "
            "split"
         << endl
         << "repeatedly. Please note that large-scale testing of this feature "
            "was limited to"
         << endl
         << "Linux systems and it might not work on others (especially Windows)." << endl
         << "" << endl
         << "The name of the new input files is composed of the name of the "
            "original"
         << endl
         << "instance, the string 'resume', a timestamp, the process ID of "
            "Minion, the name"
         << endl
         << "of the variable whose domain is being split and 0 or 1. Each of "
            "the new input"
         << endl
         << "files has a comment identifying the name of the input file which "
            "it was split"
         << endl
         << "from. Similarly, Minion's output identifies the new input files it "
            "writes when"
         << endl
         << "splitting." << endl
         << "" << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The flag -split-stderr has the same function as the flag -split, "
            "however the"
         << endl
         << "two new Minion input files are sent to standard error rather than "
            "written to files. "
         << endl
         << "" << endl
    ...
    cout << "The constraint" << endl
         ...
         << " abs(x,y)" << endl
         << "" << endl
         << "makes sure that x=|y|, i.e. x is the absolute value of y." << endl
         << endl
         << endl;
    cout << "Reference"
         << "------------------------------------------------------------------"
    ...
    cout << "Minion supports many constraints and these are regularly being" << endl
         << " improved and added to. In some cases multiple implementations of "
            "the"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "For a latin square this constraint is placed on the whole matrix "
            "once for each value."
         << endl
         << "It ensures there is a bipartite matching between rows and columns "
            "where the edges"
         << endl
         << "in the matching correspond to a pair (row, column) where the "
            "variable in position"
         << endl
         << "(row,column) in the matrix may be assigned to the given value." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
            "-------"
         << endl;
    cout << "" << endl << "alldiffmatrix(myVec, Value)" << endl << endl << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "This constraint adds some extra reasoning in addition to the GAC "
            "Alldifferents"
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that z=|x-y| in any solution." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "This constraint can be expressed in a much longer form, this form "
            "both avoids"
         << endl
         << "requiring an extra variable, and also gets better propagation. It "
            "gets bounds"
         << endl
         << "consistency." << endl
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << "y*(x/y) + x % y = x" << endl
         << "" << endl
         << "The constraint is always false when y = 0" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << "then what you want is a plain div constraint!" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint element one is identical to element, except that the" << endl
         << "vector is indexed from 1 rather than from 0." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "See" << endl
         ...
         << "" << endl
         << "for details of the element constraint which is almost identical "
            "to this"
         << endl
         << "one." << endl
         << endl
    ...
    cout << "Notes"
         ...
         << endl;
    cout << "" << endl
         << "Warning: This constraint is not confluent. Depending on the order "
            "the"
         << endl
         << "propagators are called in Minion, the number of search nodes may "
            "vary when"
         << endl
         << "using element. To avoid this problem, use watchelement instead. "
            "More details"
         << endl
         << "below." << endl
         << "" << endl
         << "The level of propagation enforced by this constraint is not "
            "named, however it"
         << endl
         ...
         << "" << endl
         << "- When e is assigned, removes idx from the domain of i whenever e "
            "is not an"
         << endl
         << " element of the domain of vec[idx]." << endl
         << "" << endl
         << "- When m[idx] is assigned, removes idx from i when m[idx] is not "
            "in the domain"
         << endl
         << " of e." << endl
         << "" << endl
         << "This level of consistency is designed to avoid the propagator "
            "having to scan"
         << endl
         << "through vec, except when e is assigned. It does a quantity of "
            "cheap propagation"
         << endl
         << "and may work well in practise on certain problems." << endl
         << "" << endl
         << "Element is not confluent, which may cause the number of search "
            "nodes to vary"
         << endl
         << "depending on the order in which constraints are listed in the "
            "input file, or"
         << endl
         << "the order they are called in Minion. For example, the following "
            "input causes"
         << endl
         ...
         << "**EOF**" << endl
         << "" << endl
         << "However if the two constraints are swapped over, Minion explores "
            "29 nodes."
         << endl
         << "As a rule of thumb, to get a lower node count, move element "
            "constraints"
         << endl
         << "to the end of the list." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "See the entry" << endl
         ...
         << "" << endl
         << "for details of an identical constraint that enforces generalised "
            "arc"
         << endl
         << "consistency." << endl
         << endl
    ...
    cout << "This constraint is identical to watchelement, except the vector" << endl
         << " is indexed from 1 rather than from 0." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "See entry" << endl
         ...
         << " help constraints element" << endl
         << " " << endl
         << " for details of an identical constraint that enforces a lower "
            "level of"
         << endl
         << " consistency." << endl
         << endl
    ...
    cout << "Example"
         << "------------------------------------------------------------------"
            "-------"
         << endl;
    cout << "Suppose the input file had the following vector of variables "
            "defined:"
         << endl
         << "" << endl
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << " takes two vectors vec0 and vec1 of the same length and ensures "
            "that"
         << endl
    ...
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "This constraint achieves GAC even when some variables are "
            "repeated in"
         << endl
         << " vec0 and vec1. However, the extra propagation this achieves is "
            "rarely"
         << endl
         << " worth the extra work." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "An extensional constraint that enforces GAC. The constraint is" << endl
         ...
         << "The format, and usage of gacschema, is identical to the 'table' "
            "constraint."
         << endl
         << "It is difficult to predict which out of 'table' and 'gacschema' "
            "will be faster"
         << endl
    ...
    cout << "An extensional constraint that enforces GAC. The constraint is" << endl
         ...
         << "The variables used in the constraint have to be BOOL or DISCRETE "
            "variables."
         << endl
         << "Other types are not supported." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "To specify a constraint over 3 variables that allows assignments" << endl
         ...
         << "" << endl
         << "and now the variables of myvec will satisfy the constraint myext." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraints extension can also be specified in the constraint" << endl
         << "definition, e.g.:" << endl
         << "" << endl
         << "table(myvec, {<0,0,0>,<1,0,0>,<0,1,0>,<0,0,1>})" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         ...
         << endl;
    cout << "An extensional constraint that enforces GAC. The constraint is" << endl
         << "specified via a list of disallowed tuples." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The Generalized Cardinality Constraint (GCC) constrains the "
            "number of each value"
         << endl
         << "that a set of variables can take." << endl
         << "" << endl
         << "gcc([primary variables], [values of interest], [capacity "
            "variables])"
         << endl
         << "" << endl
         ...
         << "" << endl
         << "This constraint only restricts the number of occurrences of the "
            "values in"
         << endl
         << "the value list. There is no restriction on the occurrences of "
            "other values."
         << endl
         << "Therefore the semantics of gcc are identical to a set of "
            "occurrence "
         << endl
         << "constraints:" << endl
         << "" << endl
    ...
    cout << "Example"
         << "------------------------------------------------------------------"
            "-------"
         << endl;
    cout << "Suppose the input file had the following vectors of variables "
            "defined:"
         << endl
         << "" << endl
         << "DISCRETE myVec[9] {1..9}" << endl
         ...
         << "" << endl
         << "The following constraint would restrict the occurrence of values "
            "1..9 in myVec"
         << endl
         << "to be at most 2 each initially, and finally equal to the values "
            "of the cap"
         << endl
         << "vector." << endl
         << "" << endl
         << "gcc(myVec, [1,2,3,4,5,6,7,8,9], cap)" << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "This constraint enforces a hybrid consistency. It reads the "
            "bounds of the"
         << endl
         << "capacity variables, then enforces GAC over the primary variables "
            "only. Then the"
         << endl
         << "bounds of the capacity variables are updated using flow "
            "algorithms similar to"
         << endl
         << "those proposed by Quimper et al, Improved Algorithms for the "
            "Global Cardinality"
         << endl
         << "Constraint (CP 2004)." << endl
         << "" << endl
         << "This constraint provides stronger propagation to the capacity "
            "variables than the"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The Generalized Cardinality Constraint (GCC) (weak variant) "
            "constrains the "
         << endl
         << "number of each value that a set of variables can take." << endl
         << "" << endl
         << "gccweak([primary variables], [values of interest], [capacity "
            "variables])"
         << endl
         << "" << endl
         << "For each value of interest, there must be a capacity variable, "
         ...
         << "the value list. There is no restriction on the occurrences of "
            "other values."
         << endl
         << "Therefore the semantics of gccweak are identical to a set of "
            "occurrence "
         << endl
         << "constraints:" << endl
         << "" << endl
    ...
    cout << "Suppose the input file had the following vectors of variables "
         ...
         << "vector." << endl
         << "" << endl
         << "gccweak(myVec, [1,2,3,4,5,6,7,8,9], cap)" << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "This constraint enforces a hybrid consistency. It reads the "
         ...
         << "capacity variables, then enforces GAC over the primary variables "
            "only. Then the"
         << endl
         << "bounds of the capacity variables are updated by counting values "
            "in the domains"
         << endl
         << "of the primary variables." << endl
         << "" << endl
         << "The consistency over the capacity variables is weaker than the "
            "gcc constraint, "
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "An extensional constraint that enforces GAC. This constraint make "
            "uses"
         << endl
         << "of 'short tuples', which allow some values to be marked as don't "
            "care."
         << endl
         << "When this allows the set of tuples to be reduced in size, this "
            "leads to"
         << endl
    ...
    cout << "" << endl
         ...
         << "x1,x2,x3,x4." << endl
         << "" << endl
         << "Represented as a TUPLELIST for a table or gacschema constraint, "
            "this would"
         << endl
         << "look like:" << endl
         << "" << endl
         ...
         << "1 1 1 1" << endl
         << "" << endl
         << "Short tuples give us a way of shrinking this list. Short tuples "
            "consist"
         << endl
         << "of pairs (x,y), where x is a varible position, and y is a value "
            "for that"
         << endl
         ...
         << "[(0,0),(3,0)]" << endl
         << "" << endl
         << "Represents 'If the variable at index 0 is 0, and the variable at "
            "index"
         << endl
         ...
         << "" << endl
         << "Note that some tuples are double-represented here. The first 3 "
            "short"
         << endl
         << "tuples all allow the assignment '0 0 0 0'. This is fine. The "
            "important"
         << endl
         ...
         << "" << endl
         << "and now the variables [x1,x2,x3,x4] will satisfy the constraint "
            "mycon."
         << endl
         << endl
         << endl;
    ...
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "Minion has no strict inequality (<) constraints. However x < y "
            "can be"
         << endl
         << "achieved by" << endl
         << "" << endl
    ...
    cout << "The constraint" << endl
         ...
         << "vec0 is lexicographically less than vec1 in any solution." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "MDDC (mddc) is an implementation of MDDC(sp) by Cheng and Yap. It "
            "enforces GAC on a"
         << endl
         ...
         << "The MDD required for the propagator is constructed from a set of "
            "satisfying"
         << endl
         << "tuples. The constraint has the same syntax as 'table' and can "
            "function"
         << endl
         << "as a drop-in replacement." << endl
         << "" << endl
         << "For examples on how to call it, see the help for 'table'. "
            "Substitute 'mddc' for"
         << endl
         << "'table'." << endl
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Negative MDDC (negativemddc) is an implementation of MDDC(sp) by "
            "Cheng and Yap."
         << endl
         << "It enforces GAC on a constraint using a multi-valued decision "
            "diagram (MDD)."
         << endl
         << "" << endl
         << "The MDD required for the propagator is constructed from a set of "
            "unsatisfying"
         << endl
         << "(negative) tuples. The constraint has the same syntax as "
            "'negativetable' and"
         << endl
         << "can function as a drop-in replacement." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << " max(vec, x)" << endl
         << "" << endl
         << "ensures that x is equal to the maximum value of any variable in "
            "vec."
         << endl
         << endl
         << endl;
    ...
    cout << "The constraint" << endl
         ...
         << " min(vec, x)" << endl
         << "" << endl
         << "ensures that x is equal to the minimum value of any variable in "
            "vec."
         << endl
         << endl
         << endl;
    ...
    cout << "The constraint" << endl
         ...
         << "This constraint exists for certain special requirements." << endl
         << "In general, if you are unsure what constraint to use," << endl
         << "then what you want is a plain mod constraint!" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << " nvalueleq(V,x)" << endl
         << "" << endl
         << "ensures that there are <= x different values assigned to the list "
            "of variables V."
         << endl
         << endl
         << endl;
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that there are AT MOST count occurrences of the value "
            "elem in"
         << endl
         << "the vector vec." << endl
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that there are AT LEAST count occurrences of the value "
            "elem in"
         << endl
         << "the vector vec." << endl
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << " product(x,y,z)" << endl
         << "" << endl
         << "ensures that z=xy in any solution." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "This constraint can be used for (and, in fact, has a specialised" << endl
         << "implementation for) achieving boolean AND, i.e. x & y=z can be "
            "modelled"
         << endl
         << "as" << endl
         << "" << endl
         << " product(x,y,z)" << endl
         << "" << endl
         << "The general constraint achieves bounds generalised arc "
            "consistency for"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "ShortSTR2 is the algorithm described in the IJCAI 2013 paper by "
            "Jefferson and"
         << endl
         << "Nightingale. It is an extension of STR2+ by Christophe Lecoutre, "
            "adapted for"
         << endl
         << "short supports." << endl
         << endl
    ...
    cout << "Example"
         ...
         << endl;
    cout << "" << endl
         << "Input format is exactly the same as haggisgac. Refer to the "
            "haggisgac and"
         << endl
         ...
         << "" << endl
         << "**CONSTRAINTS**" << endl
         << "shortstr2([x1,x2,x3,x4], mycon)" << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "str2plus is an implementation of the STR2+ algorithm by "
            "Christophe Lecoutre."
         << endl
         << endl
         << endl;
    cout << "Example"
         ...
         << endl;
    cout << "" << endl
         << "str2plus is invoked in the same way as all other table "
            "constraints, such"
         << endl
    ...
    cout << "Reification is provided in two forms: reify and reifyimply." << endl
         ...
         << "" << endl
         << "ensures that r is set to 1 if and only if constraint is "
            "satisfied. That is, if r"
         << endl
         << "is 0 the constraint must NOT be satisfied; and if r is 1 it must "
            "be satisfied as"
         << endl
         << "normal. Conversely, if the constraint is satisfied then r must be "
            "1, and if not"
         << endl
         ...
         << "" << endl
         << "only checks that if r is set to 1 then constraint must be "
            "satisfied. If r is not"
         << endl
         << "1, constraint may be either satisfied or unsatisfied. Furthermore "
            "r is never set"
         << endl
         << "by propagation, only by search; that is, satisfaction of "
            "constraint does not"
         << endl
         << "affect the value of r." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "ALMOST ALL constraints are are reifiable. Individual constraint "
            "entries mention"
         << endl
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that constantVec.varVec <= total, where "
            "constantVec.varVec is"
         << endl
         << "the scalar dot product of constantVec and varVec." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint litsumgeq(vec1, vec2, c) ensures that there exists "
            "at least c"
         << endl
         << "distinct indices i such that vec1[i] = vec2[i]." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "A SAT clause {x,y,z} can be created using:" << endl
         ...
         << "" << endl
         << "Note also that this constraint is more efficient for smaller "
            "values of c. For"
         << endl
         << "large values consider using watchsumleq." << endl
         << endl
         << endl;
    cout << "Reifiability"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that the constraints C1,...,Cn are all true." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "pointless, bearing in mind that a CSP is simply a conjunction of "
            "constraints"
         << endl
         << "already! However sometimes it may be necessary to use a "
            "conjunction as a child"
         << endl
         << "of another constraint, for example in a reification:" << endl
         << "" << endl
         << " reify(watched-and({...}),r)" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that at least one of the constraints C1,...,Cn is true." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint watchsumgeq(vec, c) ensures that sum(vec) >= c." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
    ...
    cout << "For this constraint, small values of c are more efficient." << endl
         ...
         << "" << endl
         << " This constraint works on 0/1 variables only." << endl
         << endl
         << endl;
    cout << "Reifiability"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint watchsumleq(vec, c) ensures that sum(vec) <= c." << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "Equivalent to litsumgeq([vec1,...,vecn], [0,...,0], n-c) but "
            "faster."
         << endl
         << "" << endl
         << " This constraint works on binary variables only." << endl
         << "" << endl
         << " For this constraint, large values of c are more efficient." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "The constraint" << endl
         ...
         << " hamming(X,Y,c)" << endl
         << "" << endl
         << "ensures that the hamming distance between X and Y is at least c. "
            "That is, that"
         << endl
         << "the size of the set {i | X[i] != y[i]} is greater than or equal "
            "to c."
         << endl
         << endl
         << endl;
    ...
    cout << "The constraint" << endl
         ...
         << "" << endl
         << "ensures that A and B are not the same vector, i.e., there exists "
            "some index i"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint w-inintervalset(x, [a1,a2, b1,b2, ... ]) ensures "
            "that the value"
         << endl
         << "of x belongs to one of the intervals {a1,...,a2}, {b1,...,b2} "
            "etc. The list of"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint w-inset(x, [a1,...,an]) ensures that x belongs to "
            "the set"
         << endl
         << "{a1,..,an}." << endl
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint w-notinrange(x, [a,b]) ensures that x < a or b < x." << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The constraint w-notinset(x, [a1,...,an]) ensures that x does not "
            "belong to the"
         << endl
         << "set {a1,..,an}." << endl
         << endl
    ...
    cout << "" << endl
         ...
         << "argument. This file contains a specification of the CSP to be "
            "solved"
         << endl
         << "as well as settings that the search process should use. The "
            "format is"
         << endl
         << "" << endl
         ...
         << "" << endl
         << "See the associated help entries below for information on each "
            "section."
         << endl
         << endl
         << endl;
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "You can give an input file via standard input by specifying '--' "
            "as the file"
         << endl
         << "name, this might help when minion is being used as a tool in a "
            "shell script or"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "The variables section consists of any number of variable "
            "declarations"
         << endl
    ...
    cout << "**VARIABLES**" << endl
         ...
         << "DISCRETE d[3] {1..3} #array of discrete vars" << endl
         << endl
         << endl;
    cout << "References"
         << "------------------------------------------------------------------"
    ...
    cout << "**SHORTTUPLELIST**" << endl
         ...
         << "" << endl
         << "" << endl
         << "Note that some tuples are double-represented in the example "
            "'mycon'."
         << endl
         << "The first 3 short tuples all allow the assignment '0 0 0 0'. This "
            "is fine."
         << endl
    ...
    cout << "" << endl
         ...
         << "" << endl
         << "If a variable order is given as a command line argument it will "
            "override"
         << endl
         ...
         << " <ValOrder>?" << endl
         << "" << endl
         << "In each VarOrder an instantiation order is specified for a subset "
            "of"
         << endl
         << "variables. Variables can optionally be \"auxiliary variables\" "
            "(add \"AUX\" to"
         << endl
         << "the varorder) meaning that if there are several solutions to the "
            "problem"
         << endl
         << "differing only in the auxiliary variables, only one is reported by "
            "minion."
         << endl
         << "" << endl
         ...
         << endl
         << "" << endl
         << "The value ordering allows the user to specify an instantiation "
            "order"
         << endl
         << "for the variables involved in the variable order, either ascending "
            "(a)"
         << endl
         << "or descending (d) for each. When no value ordering is specified, "
            "the"
         << endl
         ...
         << "printed. By default (no PrintFormat specified) all the variables "
            "are"
         << endl
         << "printed in declaration order. Alternatively a custom vector, or ALL" << endl
         << "variables, or no (NONE) variables can be printed. If a matrix or, "
            "more"
         << endl
         << "generally, a tensor is given instead of a vector, it is "
            "automatically"
         << endl
    ...
    cout << "Example"
         << "------------------------------------------------------------------"
            "-------"
         << endl;
    cout << "Below is a complete minion input file with commentary, as an "
            "example."
         << endl
         << "" << endl
         << "MINION 3" << endl
         ...
         << "" << endl
         << "# Internally, Bound variables are stored only as a lower and upper "
            "bound"
         << endl
         << "# Whereas discrete variables allow any sub-domain" << endl
         << "" << endl
         << "SPARSEBOUND s {1,3,6,7} # Sparse bound variables take a sorted "
            "list of values"
         << endl
         << "" << endl
         << "# We can also declare matrices of variables!" << endl
         << "" << endl
         << "DISCRETE q[3] {0..5} # This is a matrix with 3 variables: "
            "q[0],q[1] and q[2]"
         << endl
         << "BOOL bm[2,2] # A 2d matrix, variables bm[0,0], bm[0,1], bm[1,0], "
            "bm[1,1]"
         << endl
         ...
         << "**SEARCH**" << endl
         << "" << endl
         << "# Note that everything in SEARCH is optional, and can only be "
            "given at"
         << endl
         << "# most once!" << endl
         << "" << endl
         << "# If you don't give an explicit variable ordering, one is "
            "generated."
         << endl
         << "# These can take matrices in interesting ways like constraints, "
            "see below."
         << endl
         ...
         << "**CONSTRAINTS**" << endl
         << "" << endl
         << "# Constraints are defined in exactly the same way as in MINION "
            "input"
         << endl
         << "formats 1 & 2" << endl
         << "eq(bool, 0)" << endl
         ...
         << "# to vary. Just giving a matrix gives all the variables in that "
            "matrix."
         << endl
         << "" << endl
         ...
         << "# [ bn[1,_,0,_] = [ bn[1,0,0,0], b[1,0,0,1], b[1,1,0,0], "
            "b[1,1,0,1] ]"
         << endl
         << "" << endl
         ...
         << "" << endl
         << "# One minor problem.. you must always put [ ] around any matrix "
            "expression, so"
         << endl
         ...
         << "" << endl
         << "#No need to put everything in one section! All sections can be "
            "reopened.."
         << endl
         << "**VARIABLES**" << endl
         << "" << endl
         ...
         << endl
         << "# the moment." << endl
         << "# On the other hand, I might remove this altogether, as it's worse "
            "than giving"
         << endl
         << "# Tuplelists" << endl
         << "" << endl
         ...
         << "**EOF**" << endl
         << "" << endl
         << "Any text down here is ignored, so you can write whatever you like "
            "(or"
         << endl
         << "nothing at all...)" << endl
         << endl
    ...
    cout << "Minion supports 4 different variable types, namely" << endl
         ...
         << "opportunity for optimisation. In general, we recommend thinking of "
            "the"
         << endl
         ...
         << "Minion also supports use of constants in place of variables, and "
            "constant"
         << endl
         << "vectors in place of vectors of variables. Using constants will be "
            "at least"
         << endl
         << "as efficient as using variables when the variable has a singleton "
            "domain."
         << endl
         << "" << endl
         << "See the entry on vectors for information on how vectors, matrices "
            "and,"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Minion supports the use of constants anywhere where a variable "
            "can be used. For"
         << endl
         << "example, in a constraint as a replacement for a single variable, "
            "or a vector of"
         << endl
         << "constants as a replacement for a vector of variables." << endl
         << endl
         << endl;
    cout << "Examples"
         << "------------------------------------------------------------------"
    ...
    cout << "Vectors, matrices and tensors can be declared in minion" << endl
         << "input. Matrices and tensors are for convenience, as constraints "
            "do not"
         << endl
         << "take these as input; they must first undergo a flattening process "
            "to"
         << endl
         << "convert them to a vector before use. Additional commas at the end "
            "of"
         << endl
         << "vectors are ignored (see example below)." << endl
         << endl
         << endl;
    cout << "Examples"
         << "------------------------------------------------------------------"
    ...
    cout << "A vector of 0/1 variables:" << endl
         ...
         << "whose entries have been strung out into a vector in index order "
            "with"
         << endl
         ...
         << "" << endl
         << "alldiff([sudoku[0,0],...,sudoku[0,8],...,sudoku[8,0],...,sudoku[8,"
            "8]])"
         << endl
         << "" << endl
         << "Furthermore, with indices filled selectively and the remainder "
            "filled"
         << endl
    ...
    cout << "Additional hanging commas at the end of array are ignored, e.g." << endl
         ...
         << "lexleq([A,B,C],[D,E,F])" << endl
         << "" << endl
         << "This feature is provided to make it easier to computer-generate "
            "input"
         << endl
         << "files." << endl
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Specifying an alias is a way to give a variable another name. "
            "Aliases"
         << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "01 variables are used very commonly for logical expressions, and "
            "for"
         << endl
         << "encoding the characteristic functions of sets and relations. Note "
            "that"
         << endl
         << "wherever a 01 variable can appear, the negation of that variable "
            "can"
         << endl
         << "also appear. A boolean variable x's negation is identified by !x." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "Bounds variables, where only the upper and lower bounds of the "
            "domain"
         << endl
         << "are maintained. These domains must be continuous ranges of integers" << endl
         << "i.e. holes cannot be put in the domains of the variables." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "In discrete variables, the domain ranges between the specified "
            "lower and upper"
         << endl
         << "bounds, but during search any domain value may be pruned, i.e., "
            "propagation and"
         << endl
         << "search may punch arbitrary holes in the domain." << endl
         << endl
         << endl;
    cout << "Example"
         << "------------------------------------------------------------------"
            "-------"
         << endl;
    cout << "Declaration of a discrete variable x with domain {1,2,3,4} in "
            "input file:"
         << endl
         << "" << endl
         << "DISCRETE x {1..4}" << endl
    ...
    cout << "Description"
         << "------------------------------------------------------------------"
            "---"
         << endl;
    cout << "In sparse bounds variables the domain is composed of discrete "
            "values"
         << endl
         ...
         << "variables is not a continuous range, any holes in the domains must "
            "be"
         << endl
    ...
    cout << "Notes"
         << "------------------------------------------------------------------"
            "---------"
         << endl;
    cout << "Declaration of a sparse bounds variable called myvar containing "
            "values"
         << endl
         ...
         << "" << endl
         << "Use of this variable in a constraint:" << endl
         << "eq(myvar, 3) #myvar equals 3" << endl
         << endl
         << endl;
  } else
