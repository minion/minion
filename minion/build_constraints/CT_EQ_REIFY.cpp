...
{ return new ReifiedEqualConstraint<EqualVarRef1, EqualVarRef1, BoolVarRef>(stateObj,var1[0],var2[0],var3[0]); }
...
{ return new ReifiedEqualConstraint<AnyVarRef, AnyVarRef, BoolVarRef>(stateObj,AnyVarRef(var1[0]),AnyVarRef(var2[0]),var3[0]); }
