...
AbstractConstraint*
BuildCT_ELEMENT_UNDEFZERO(StateObj* stateObj, const Var1& vararray, const Var2& v1, const Var1& v2, ConstraintBlob&)
{ 
...
AbstractConstraint*
BuildCT_ELEMENT_UNDEFZERO(StateObj* stateObj, Var1 vararray, const Var2& v1, const Var3& v2, ConstraintBlob&)
{ 
