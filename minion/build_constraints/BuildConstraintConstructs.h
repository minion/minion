...
struct BuildConObj
{
  ...
  static
  AbstractConstraint* build(const ConData& partial_build, ConstraintBlob& b, SysInt pos) DOM_NOINLINE;
};
...
build(const ConData& partial_build, ConstraintBlob& b, SysInt pos)
{
...
AbstractConstraint*
build_constraint(ProbSpec::ConstraintBlob& b);
