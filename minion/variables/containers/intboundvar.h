...
//  BoundVarRef get_new_var(SysInt i, SysInt j);
  ...
  void addDynamicTrigger(AbstractConstraint* ac, BoundVarRef_internal<BoundType>& b, DynamicTrigger* t, TrigType type, DomainInt pos = NoDomainValue , TrigOp op = TO_Default)
  {
    D_ASSERT(lock_m);
