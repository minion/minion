...
#define FUN0(RET, NAME)                                                                            \
  RET NAME() { return data.NAME(); }
#define CFUN0(RET, NAME)                                                                           \
  RET NAME() const { return data.NAME(); }
#define FUN1(RET, NAME, ARG)                                                                       \
  RET NAME(ARG a) { return data.NAME(a); }
#define CFUN1(RET, NAME, ARG)                                                                      \
  RET NAME(ARG a) const { return data.NAME(a); }
#define FUN2(RET, NAME, ARG1, ARG2)                                                                \
  RET NAME(ARG1 a1, ARG2 a2) { return data.NAME(a1, a2); }
#define CFUN2(RET, NAME, ARG1, ARG2)                                                               \
  RET NAME(ARG1 a1, ARG2 a2) const { return data.NAME(a1, a2); }
