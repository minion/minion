...
#define VAR_INFO_ADDONE(VarType, VarEvent) VarInfoAddone(VarType, VAR_INFO_##VarEvent)

#define CON_INFO_ADDONE(ConEvent) ConInfoAddone(CON_INFO_##ConEvent)

#define PROP_INFO_ADDONE(PropEvent) PropInfoAddone(PROP_INFO_##PropEvent)
