...
struct MDDC : public AbstractConstraint {
  virtual string constraint_name() { return "mddc"; }

  virtual string full_output_name() { return ConOutput::print_con(constraint_name(), vars); }
  ...
  void find_layer(int currentlayer, int targetlayer, MDDNode *curnode,
                  vector<MDDNode *> &nodelist) {
