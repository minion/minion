...
inline AbstractConstraint* BuildCT_DIV(const vector<VarRef1>& vars, const vector<VarRef2>& var2, ConstraintBlob&) {
...
template <typename VarRef1, typename VarRef2>
inline AbstractConstraint* BuildCT_DIV_UNDEFZERO(const vector<VarRef1>& vars, const vector<VarRef2>& var2, ConstraintBlob&) {
  D_ASSERT(vars.size() == 2);
  D_ASSERT(var2.size() == 1);
