...
AbstractConstraint* BuildCT_GCC(const VarArray1& varArray, const VarArray2& cap_array,
                                ConstraintBlob& b) {
  return new GCC<VarArray1, VarArray2, true>(varArray, cap_array, b.constants[0]);
}
