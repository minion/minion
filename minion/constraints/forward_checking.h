...
struct Forward_Checking : public AbstractConstraint {
  ...
  virtual void fullPropagate() {
    ...
    trig1 = findNewTrigger(-1, -1, 0, size, vars);
    ...
    trig2 = findNewTrigger(trig1, -1, 1, size, vars);
  ...
  virtual void propagateDynInt(SysInt dt, DomainDelta) {
    ...
    if(dt == 0) {
      ...
      SysInt temp = findNewTrigger(trig2, trig1, 0, size, vars);
      ...
      SysInt temp = findNewTrigger(trig1, trig2, 1, size, vars);
  ...
  SysInt findNewTrigger(SysInt toavoid, SysInt start, DomainInt dtthis, SysInt size,
