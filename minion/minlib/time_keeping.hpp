...
// This function is a horrible hack, to let us avoid nasty global variables leaking out of this file.
// If you want to call 'get_wall_time', then you must call init_start_wall_time first, perferably
...
inline long double init_start_wall_time(int special_check = 0)
{
    ...
    if(special_check == 0)
    {
        ...
        timeval t;
        gettimeofday(&t, NULL);
        start_time = static_cast<long double>(t.tv_sec) + static_cast<long double>(t.tv_usec) / 1000000.0;
        return -1;
    }
    else
    {
...
inline long double get_wall_time()
{
    timeval t;
    gettimeofday(&t, NULL);
    long double current_time = static_cast<long double>(t.tv_sec) + static_cast<long double>(t.tv_usec) / 1000000.0;
