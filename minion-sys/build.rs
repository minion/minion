...
fn bind(minion_src: &Path) {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("shortTupleList_new")
        .allowlist_function("shortTupleList_free")
        ...
        .allowlist_function("instance_addShortTupleTableSymbol")
        .allowlist_function("instance_getShortTupleTableSymbol")
        ...
        .allowlist_function("constraint_setShortTuples")
        .allowlist_function("constraint_setShortTuplesByName")
