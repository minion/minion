...
if (Boost_FIND_VERSION_EXACT)
  ...
  set( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} 
    "1.37.0" "1.37" "1.36.1" "1.36.0" "1.36" "1.35.1" "1.35.0" "1.35" "1.34.1" "1.34.0" 
...
ELSE (_boost_IN_CACHE)
  ...
  IF( NOT Boost_INCLUDE_DIR )
    ...
    FOREACH(_boost_VER ${_boost_TEST_VERSIONS})
      ...
      ELSE(_boost_PATH_SUFFIX MATCHES "[0-9]+\\.[0-9]+\\.[0-9]+")
          IF(_boost_PATH_SUFFIX MATCHES "[0-9]+\\.[0-9]+")
              STRING(REGEX REPLACE "([0-9]+)\\.([0-9]+)" "\\1_\\2" 
                _boost_PATH_SUFFIX ${_boost_PATH_SUFFIX})
          ENDIF(_boost_PATH_SUFFIX MATCHES "[0-9]+\\.[0-9]+")
