...
if (Boost_FIND_VERSION_EXACT)
  ...
  set( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} 
    "1.39.1" "1.39.0" "1.39" "1.38.0" "1.38" "1.37.0" "1.37" "1.36.1" "1.36.0" "1.36" "1.35.1" "1.35.0" "1.35" "1.34.1" "1.34.0" 
...
ELSE (_boost_IN_CACHE)
  ...
  FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
    ...
    IF(CYGWIN)
      FOREACH(SUF ${CMAKE_FIND_LIBRARY_SUFFIXES})
        SET(CMAKE_FIND_LIBRARY_SUFFIXES "-gcc-mt${SUF}" ${CMAKE_FIND_LIBRARY_SUFFIXES})
      ENDFOREACH(SUF ${CMAKE_FIND_LIBRARY_SUFFIXES})
    ENDIF(CYGWIN)
