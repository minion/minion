...
cp translator/translator.jar minion-release-$1/eprime-translator.jar
cp translator/README minion-release-$1/README.translator
cp -r translator/examples minion-release-$1/translator-examples
cp -r translator/doc minion-release-$1/translator-doc
